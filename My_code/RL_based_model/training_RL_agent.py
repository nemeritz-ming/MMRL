...
if __name__ == '__main__':
    for t in ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10",
        ...
        if t == '31':
            url = '/Users/ming/Documents/Project/data/LOB/BTCUSDT_S_DEPTH_202110{0}.csv'.format(t)
        else:
            url = '/Users/ming/Documents/Project/data/LOB/BTCUSDT_S_DEPTH_202111{0}.csv'.format(t)
        # read the data.
        ...
        # create RL agent
        agent = PolicyGradientAgent(learning_rate=0.001, input_dims=[13], GAMMA=0.99, n_actions=6,
        ...
        torch.save(agent.policy.state_dict(), "test__{0}.pt".format(t))
